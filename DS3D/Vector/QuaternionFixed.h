...
static inline iquat_t iquatinverse(iquat_t q)
{
	int32_t sq=iquatsq(q);
	return iquat(idiv(q.r,sq),ivec3div(q.i,sq));
}
...
{
	return iquat(imul(a.r,b.r)-ivec3dot(a.i,b.i),
...
static inline iquat_t iquatrealmul(iquat_t a,int32_t b) { return iquat(imul(a.r,b),ivec3mul(a.i,b)); }
static inline iquat_t iquatrealdiv(iquat_t a,int32_t b) { return iquat(idiv(a.r,b),ivec3div(a.i,b)); }
...
static inline int32_t iquatdot(iquat_t a,iquat_t b) { return imul(a.r,b.r)+ivec3dot(a.i,b.i); }
...
{
	return iquat(a.r+imul((b.r-b.r),t),ivec3mix(a.i,b.i,t));
}
...
/*static inline iquat_t iquatslerp(iquat_t a,iquat_t b,int32_t t)
{
	...
	return iquatadd(
		iquatrealmul(a,idiv(isin(imul((F(1)-t),angle)),sin_a)),
		iquatrealmul(b,idiv(isin(imul(t,angle)),sin_a)));
}*/
...
static inline imat4x3_t imat4x3quat(iquat_t q) { return imat4x3affine3x3(imat3x3quat(q)); }
static inline imat4x4_t imat4x4quat(iquat_t q) { return imat4x4affine3x3(imat3x3quat(q)); }
