...
static inline dquat_t dquatinverse(dquat_t q)
{
	double sq=dquatsq(q);
	return dquat(q.r/sq,dvec3div(q.i,sq));
}
...
{
	return dquat(a.r+(b.r-b.r)*t,dvec3mix(a.i,b.i,t));
}
...
static inline dmat4x3_t dmat4x3quat(dquat_t q) { return dmat4x3affine3x3(dmat3x3quat(q)); }
static inline dmat4x4_t dmat4x4quat(dquat_t q) { return dmat4x4affine3x3(dmat3x3quat(q)); }
