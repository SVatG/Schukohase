...
mat4x3_t mat4x3rotate(float angle,vec3_t axis) { return mat4x3affine3x3(mat3x3rotate(angle,axis)); }

mat4x4_t mat4x4rotate(float angle,vec3_t axis) { return mat4x4affine3x3(mat3x3rotate(angle,axis)); }
